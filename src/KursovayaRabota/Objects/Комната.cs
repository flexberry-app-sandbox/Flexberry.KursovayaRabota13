...
namespace IIS.KursovayaRabota
{
    ...
    [View("КомнатаE", new string[] {
            ...
            "Считыватель as \'Уникальный код считывателя\'"})]
    [MasterViewDefineAttribute("КомнатаE", "Считыватель", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "УникальныйКод")]
    [View("КомнатаL", new string[] {
            "НомерКомнаты as \'Номер комнаты\'",
            "Этаж as \'Этаж\'",
            "КоличествоМест as \'Количество мест\'",
            "Считыватель.УникальныйКод as \'Уникальный код считывателя\'"})]
    public class Комната : ICSSoft.STORMNET.DataObject
    {
        ...
        /// Комната.
        /// </summary>
        // *** Start programmer edit section *** (Комната.Считыватель CustomAttributes)

        // *** End programmer edit section *** (Комната.Считыватель CustomAttributes)
        ...
        public virtual IIS.KursovayaRabota.Считыватель Считыватель
        {
            get
            {
                // *** Start programmer edit section *** (Комната.Считыватель Get start)

                // *** End programmer edit section *** (Комната.Считыватель Get start)
                IIS.KursovayaRabota.Считыватель result = this.fСчитыватель;
                // *** Start programmer edit section *** (Комната.Считыватель Get end)

                // *** End programmer edit section *** (Комната.Считыватель Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Комната.Считыватель Set start)

                // *** End programmer edit section *** (Комната.Считыватель Set start)
                this.fСчитыватель = value;
                // *** Start programmer edit section *** (Комната.Считыватель Set end)

                // *** End programmer edit section *** (Комната.Считыватель Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КомнатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КомнатаE", typeof(IIS.KursovayaRabota.Комната));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КомнатаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КомнатаL", typeof(IIS.KursovayaRabota.Комната));
                }
            }
        }
    }
