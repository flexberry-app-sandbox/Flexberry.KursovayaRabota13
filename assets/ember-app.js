...
define('ember-app/locales/en/forms/i-i-s-kursovaya-rabota-\u0433\u043E\u0441\u0442\u044C-e', ['exports'], function (exports) {
  ...
  exports.default = {
    ...
    'регистрацКлюча.комната.номерКомнаты-caption': 'Комната',
      ...
      входГостя: (0, _attributes.hasMany)('i-i-s-kursovaya-rabota-вход-гостя', 'Вход гостя', {
        гость: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-гость', 'Гость', {
          регистрацКлюча: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-регистрац-ключа', '', {
            ...
            комната: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-комната', '', {
              номерКомнаты: (0, _attributes.attr)('Комната', { index: 2 })
            }, { index: -1, hidden: true })
          }, { index: -1, hidden: true })
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('ГостьE', 'i-i-s-kursovaya-rabota-гость', {
      ...
      регистрацКлюча: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-регистрац-ключа', 'Номер ключа', {
        комната: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-комната', '', {
          номерКомнаты: (0, _attributes.attr)('Комната', { index: 6 })
        }, { index: -1, hidden: true })
...
define('ember-app/mixins/regenerated/models/i-i-s-kursovaya-rabota-\u043A\u043E\u043C\u043D\u0430\u0442\u0430', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('КомнатаE', 'i-i-s-kursovaya-rabota-комната', {
      ...
      считыватель: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-считыватель', 'Уникальный код считывателя', {}, { index: 3, displayMemberPath: 'уникальныйКод' })
    });
    ...
    modelClass.defineProjection('КомнатаL', 'i-i-s-kursovaya-rabota-комната', {
      ...
      этаж: (0, _attributes.attr)('Этаж', { index: 1 }),
      количествоМест: (0, _attributes.attr)('Количество мест', { index: 2 }),
      считыватель: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-считыватель', 'Уникальный код считывателя', {
        уникальныйКод: (0, _attributes.attr)('Уникальный код считывателя', { index: 3 })
      }, { index: -1, hidden: true })
    });
  };
});
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('РегистрацКлючаE', 'i-i-s-kursovaya-rabota-регистрац-ключа', {
      ...
      комната: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-комната', 'Номер комнаты', {
        считыватель: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-считыватель', '', {
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        ...
        'i-i-s-kursovaya-rabota-комната': 'id,количествоМест,номерКомнаты,этаж,считыватель',
        'i-i-s-kursovaya-rabota-регистрац-ключа': 'id,дата,номерКлюча,срокДействия,карта,комната,сотрудник',
